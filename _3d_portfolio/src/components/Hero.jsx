...
export const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className="px-4 absolute max-w-screen-2xl inset-0 top-[120px] mx-auto flex items-start gap-5">
        {/* Line div */}
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-300 text-[20px] lg:text-[25px] max-w-[50ch] lg:max-w-[45ch] tracking-wider">
